...
class PublicBootstrapTests(unittest.TestCase):
    def test_metadata_is_exact_pre_alpha_public_preview(self) -> None:
        ...
        self.assertEqual(project["version"], "0.0.11")
    ...
    def test_source_version_fallback_matches_numeric_release(self) -> None:
        ...
        self.assertEqual(namespace["__version__"], "0.0.11")

    def test_registry_is_explicit_complete_and_default_deny(self) -> None:
        records = load_registry()
        self.assertEqual(len(records), 63)
        self.assertEqual(len({record["id"] for record in records}), 63)
        ...
        self.assertEqual(counts["json_schema"], 57)
    ...
    def test_boundary_scan_is_clean(self) -> None:
        result = verify()
        self.assertEqual(result["record_count"], 63)
    ...
    def test_publisher_has_narrow_owner_approved_controls(self) -> None:
        ...
        self.assertIn('tags: ["v0.0.11"]', workflow)
        self.assertEqual(workflow.count("refs/tags/v0.0.11"), 2)
        ...
        self.assertNotIn("v0.0.11a1", workflow)
    ...
    def test_candidate_ci_matches_committed_inventory(
        ...
        self.assertIn('tags: ["v0.0.11"]', publishing)
