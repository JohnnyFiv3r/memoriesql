# Declared evidence scopes (unreleased schema 25)
...
This development change is not published 0.0.8, despite retaining that package
metadata. A separately authorized release must precede downstream consumption.
